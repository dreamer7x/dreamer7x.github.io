...
def create_data():
    ...
    sql03 = 'insert identity_attentions_fans(sStaticId,iAttentionsNumber,iFansNumber,sAttentionsStaticId,sFansStaticId) ' \
            'value(9,1,2,"[10]","[10,11]")'
    sql04 = 'insert identity_attentions_fans(sStaticId,iAttentionsNumber,iFansNumber,sAttentionsStaticId,sFansStaticId) ' \
            'value(10,2,1,"[9,11]","[9]")'
    sql05 = 'insert identity_attentions_fans(sStaticId,iAttentionsNumber,iFansNumber,sAttentionsStaticId,sFansStaticId) ' \
            'value(11,1,1,"[9]","[10]")'
    sql06 = 'insert identity_chat(sStaticId,sNewDrivingChat,sNewPassiveChat,sDrivingChat,sPassivveChat,sOldDrivingChat,sOldPassiveChat,sChatOrder) ' \
            'value(9,"[]","[]","[11,10]","[]","[11,10]","[]","00")'
    sql07 = 'insert identity_chat(sStaticId,sNewDrivingChat,sNewPassiveChat,sDrivingChat,sPassivveChat,sOldDrivingChat,sOldPassiveChat,sChatOrder) ' \
            'value(10,"[]","[9]","[]","[9]","[]","[9]","1")'
    sql08 = 'insert identity_chat(sStaticId,sNewDrivingChat,sNewPassiveChat,sDrivingChat,sPassivveChat,sOldDrivingChat,sOldPassiveChat,sChatOrder) ' \
            'value(11,"[]","[9]","[]","[9]","[]","[9]","1")'
    sql09 = 'insert identity_friends(sStaticId,sFriendsStaticId,sOldNewFriendsStaticId,sNewFriendsStaticId,sBlackList,sIntroduce) ' \
            'value(9,"[10]","[11]","[]","[]","{}")'
    sql10 = 'insert identity_friends(sStaticId,sFriendsStaticId,sOldNewFriendsStaticId,sNewFriendsStaticId,sBlackList,sIntroduce) ' \
            'value(10,"[9]","[]","[]","[]","{}")'
    sql11 = 'insert identity_friends(sStaticId,sFriendsStaticId,sOldNewFriendsStaticId,sNewFriendsStaticId,sBlackList,sIntroduce) ' \
            'value(11,"[]","[]","[]","[]","{}")'
    ...
    sql17 = 'insert identity_trends(sStaticId,sTrendsId,sCollectTrendsId,sNewTrendsId,sOldTrendsId) ' \
            'value(11,"[3]","[1]","[]","[8]")'
    sql18 = 'insert trends(sTrendsId,sStaticId,sTitle,sText,sPicturePosition,iPraiseNumber,iDiscussNumber,sPraiseStaticId,sDiscuss) ' \
            'value(1,9,"第一个动态","hello world","000001",1,1,"[10]","{10:["hello program",1,1,"[9]","{9:[\'hello program,too\',1,\'[10]\']}"]}"'
    sql19 = 'insert trends(sTrendsId,sStaticId,sTitle,sText,sPicturePosition,iPraiseNumber,iDiscussNumber,sPraiseStaticId,sDiscuss) ' \
            'value(2,10,"这是第二个动态","跟在你后面","000001",0,0,"[]","{}")'
    sql20 = 'insert trends(sTrendsId,sStaticId,sTitle,sText,sPicturePosition,iPraiseNumber,iDiscussNumber,sPraiseStaticId,sDiscuss) ' \
            'value(3,11,"你好世界","hello everyone","000001",1,1,"[9]","{}")'
    sql21 = 'insert trends(sTrendsId,sStaticId,sTitle,sText,sPicturePosition,iPraiseNumber,iDiscussNumber,sPraiseStaticId,sDiscuss) ' \
