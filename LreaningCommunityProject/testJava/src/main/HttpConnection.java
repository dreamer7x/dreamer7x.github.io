...
public class HttpConnection {
    ...
    public String getData(){
        if(getOnWork() != 2){
            System.out.println("HttpConnectionDemo" + "警告: getData方法执行警告 当前没有数据提供");
            return "";
        }
        else{
    ...
    public void sendPOST(Map<String,String> dataMap){
        if(getOnWork() != 0){
            System.out.println("HttpConnectionDemo" + "错误: sendPOST方法执行失败 有其他工作正在执行");
            return;
        }
        else {
            setOnWork();
    ...
    public void sendGET(){
        if (getOnWork() != 0) {
            System.out.println("HttpConnectionDemo" + "错误: sendPOST方法执行失败 其他工作正在执行");
            return;
        }
        else {
            setOnWork();
