...
def get_identity_sign(sStaticId): # String 类型
    conMysqlConnection = pymysql.connect(
        host=keeper.mysql_ip,
        user=keeper.database_manager_name,
        password=keeper.database_manager_password,
        database=keeper.database_name,
